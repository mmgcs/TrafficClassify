...
if __name__ == '__main__':
    ...
    #根目录
    train_data_dir = 'intrusion/train/'
    ...
    #定义神经网络：
    mynet = MyTextCnn(100,40,[4,5,6],7)
    ...
    #训练数据
    mynet=trainmodel2(mynet,train_data_loader,1,critierion,optimizer,50)

    #保存模型
    torch.save(mynet, 'attacks.pkl')
